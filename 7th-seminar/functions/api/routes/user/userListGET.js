...
module.exports = async (req, res) => {    
  ...
  try {
    ...
    // 빌려온 connection을 사용해 우리가 db/user.js에서 미리 저장한 SQL 쿼리문을 날려줍니다.
    ...
    // 이 때 단순히 console.log만 해주는 것이 아니라, Firebase 콘솔에서도 에러를 모아볼 수 있게 functions.logger.erroreh 함께 찍어줍니다.
  } catch (error) {
