...
const ramenRecipe = () => new Promise((resolve, reject) => {
  cook(() => {
    console.log('[라면 진행상황]');
    resolve('[라면 만들기 시작]');
  }, 1000);
...
const boilWater = progress => new Promise((resolve, reject) => {
...
const putTheRamenAndSoupPowder = progress => new Promise((resolve, reject) => {
...
const delayThreeMinutes = progress => new Promise((resolve, reject) => {
